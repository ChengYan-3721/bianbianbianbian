...
class BeeCountCloudStorageService implements CloudStorageService {
  ...
  // Phase 11 binary API — BeeCount Cloud is dead code in this project (the App
  // never instantiates this provider). Stubs throw to surface accidental use.
  ...
  Future<void> uploadBinary({
    ...
    throw UnimplementedError(
      'BeeCountCloudStorageService.uploadBinary not supported '
      '(BeeCount Cloud backend is disabled in this project)',
    );
  }
  ...
  Future<Uint8List?> downloadBinary({required String path}) async {
    throw UnimplementedError(
      'BeeCountCloudStorageService.downloadBinary not supported '
      '(BeeCount Cloud backend is disabled in this project)',
    );
  }
  ...
  Future<List<CloudFile>> listBinary({required String prefix}) async {
    throw UnimplementedError(
      'BeeCountCloudStorageService.listBinary not supported '
      '(BeeCount Cloud backend is disabled in this project)',
    );
  }
}
