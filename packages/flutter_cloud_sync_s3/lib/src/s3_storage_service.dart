...
class S3StorageService implements CloudStorageService {
  ...
  //   client.putObject(bucket: bucket, key: _normalizePath(path), data: bytes)
  //   client.getObject(...) returns Uint8List directly
  //   client.listObjects(prefix: ..., recursive: true) for listBinary
  ...
  Future<void> uploadBinary({
    ...
    throw UnimplementedError(
      'S3StorageService.uploadBinary not yet implemented (Phase 11.1)',
    );
  }
  ...
  Future<Uint8List?> downloadBinary({required String path}) async {
    throw UnimplementedError(
      'S3StorageService.downloadBinary not yet implemented (Phase 11.1)',
    );
  }
  ...
  Future<List<CloudFile>> listBinary({required String prefix}) async {
    throw UnimplementedError(
      'S3StorageService.listBinary not yet implemented (Phase 11.1)',
    );
  }
