...
class WebDAVStorageService implements CloudStorageService {
  ...
  // ---------------------------------------------------------------------------
  // TODO(phase-11.1): real implementation. WebDAV client.write/read accept
  //   List<int> directly so binary I/O is essentially the same as upload/
  //   download minus the utf8 encode/decode step. listBinary needs recursive
  //   traversal (readDir is single-level).
  ...
  Future<void> uploadBinary({
    ...
    throw UnimplementedError(
      'WebDAVStorageService.uploadBinary not yet implemented (Phase 11.1)',
    );
  }
  ...
  Future<Uint8List?> downloadBinary({required String path}) async {
    throw UnimplementedError(
      'WebDAVStorageService.downloadBinary not yet implemented (Phase 11.1)',
    );
  }
  ...
  Future<List<CloudFile>> listBinary({required String prefix}) async {
    throw UnimplementedError(
      'WebDAVStorageService.listBinary not yet implemented (Phase 11.1)',
    );
  }
