...
class SupabaseStorageService implements CloudStorageService {
  ...
  // ---------------------------------------------------------------------------
  // TODO(phase-11.1): real implementation using
  //   _client.storage.from(_bucketName).uploadBinary(fullPath, bytes, ...)
  // See implementation-plan.md §11.1. Skeleton signatures only — throwing
  // UnimplementedError keeps the project compiling while binary support lands.
  ...
  Future<void> uploadBinary({
    ...
    throw UnimplementedError(
      'SupabaseStorageService.uploadBinary not yet implemented (Phase 11.1)',
    );
  }
  ...
  Future<Uint8List?> downloadBinary({required String path}) async {
    throw UnimplementedError(
      'SupabaseStorageService.downloadBinary not yet implemented (Phase 11.1)',
    );
  }
  ...
  Future<List<CloudFile>> listBinary({required String prefix}) async {
    throw UnimplementedError(
      'SupabaseStorageService.listBinary not yet implemented (Phase 11.1)',
    );
  }
